 ...
 * @author Rojeru San
 */
public class Warning_Ingrese_Deposito extends javax.swing.JDialog {
    public static String id="",fecha="";
    Timer timer = null;
    TimerTask task;
    int i = 32;
     ...
     * @param modal
     */
    public Warning_Ingrese_Deposito(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        materialButton1.setBackground(new java.awt.Color(0, 111, 177));
    ...
    private void materialButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_materialButton1ActionPerformed
        modal_Deposito.idpaciente= id;
        modal_Deposito.fecha=fecha;
        new modal_Deposito(new JFrame(), true).setVisible(true); 
        task = new TimerTask() {
            @Override
            public void run() {
                if (i == 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Warning_Ingrese_Deposito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Warning_Ingrese_Deposito dialog = new Warning_Ingrese_Deposito(new javax.swing.JFrame(), true);
