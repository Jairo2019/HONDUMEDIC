 ...
 * @author Rojeru San
 */
public class Info_Message extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public Info_Message(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Info_Message.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Info_Message dialog = new Info_Message(new javax.swing.JFrame(), true);
