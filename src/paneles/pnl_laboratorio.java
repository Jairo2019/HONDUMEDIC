 ...
 * @author Rojeru San
 */
public class pnl_laboratorio extends javax.swing.JInternalFrame {
Connection con=null;
Date dato = null;
ResultSet rs=null;
PreparedStatement pst=null;
     ...
     */
    public pnl_laboratorio() {
        initComponents();
        ((javax.swing.plaf.basic.BasicInternalFrameUI) this.getUI()).setNorthPane(null);
        con= Conexion.ConnectDB();
        cn = Conexion.ConnectDB();
        Get_Data();
    ...
    private void initComponents() {
        ...
        jPanel4.setPreferredSize(new java.awt.Dimension(769, 582));
        ...
        c_search_tbl.setFont(new java.awt.Font("Rockwell", 0, 18)); // NOI18N
        ...
        btnprint.setFont(new java.awt.Font("Rockwell", 0, 18)); // NOI18N
        ...
        pnlChangeLayout.setHorizontalGroup(
            ...
            .addGroup(pnlChangeLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanel5, javax.swing.GroupLayout.DEFAULT_SIZE, 1017, Short.MAX_VALUE)
                .addContainerGap())
        ...
        jPanel6.setFont(new java.awt.Font("Rockwell", 0, 12)); // NOI18N
        jPanel6.setInheritsPopupMenu(true);
        jPanel6.setPreferredSize(new java.awt.Dimension(769, 582));
        ...
        jPanel8.setPreferredSize(new java.awt.Dimension(607, 40));
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jPanel7, javax.swing.GroupLayout.DEFAULT_SIZE, 1017, Short.MAX_VALUE)
        ...
        jTabbedPane2.addTab("Nuevo Servicio", jPanel6);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jTabbedPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 1031, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    public void extraerID() {
        ...
        try {
            ...
            if (c == null) {
                ...
                gen.generar(j);
                txtCodigo.setText("SL" + gen.serie());
    ...
    private void reporte(){
        ...
        String path = "src\\reportes_servicios\\servicios_laboratorio.jasper"; //Ponemos la localizacion del reporte creado
        try {
    ...
    private void c_search_tblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_c_search_tblKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("SELECT * FROM servicio_laboratorio WHERE nombre LIKE '%"+name+"%' ");
  ...
  private void Get_Data(){
        Reset();
        String sql="select codigo_laboratorio as 'Codigo', nombre as 'Nombre', descripcion as 'Descripción', precio as 'Precio' from servicio_laboratorio";
    ...
    private void Reset()
{
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        try{
            ...
            String sql= "insert into servicio_laboratorio(codigo_laboratorio,nombre,descripcion,precio) values ('"+txtCodigo.getText()+"','" +txtName.getText()+"','" + txtDescripcion.getText() +"','" +txtPrecio.getText()+ "')";

            pst=con.prepareStatement(sql);
            pst.execute();

            JOptionPane.showMessageDialog(this,"Registrado con éxito","Servicio Laboratorio",JOptionPane.INFORMATION_MESSAGE);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        try{
            con=Conexion.ConnectDB();
            String sql= "update servicio_laboratorio set nombre='"+ txtName.getText()+ "',descripcion='" + txtDescripcion.getText() + "',precio='" + txtPrecio.getText() + "' where codigo_laboratorio='" + txtCodigo.getText()+ "'";
            pst=con.prepareStatement(sql);
            pst.execute();
            JOptionPane.showMessageDialog(this,"Servico Actualizado","Servicio de Laboratorio",JOptionPane.INFORMATION_MESSAGE);
            btnUpdate.setEnabled(false);
            this.jTabbedPane2.setSelectedIndex(0);
            Get_Data();
            Reset();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try
        {
            ...
            if (P==0)
            {
                ...
                String sql= "delete from servicio_laboratorio where codigo_laboratorio = '" + txtCodigo.getText() + "'";
                pst=con.prepareStatement(sql);
                //        pst.execute();
    ...
    private void c_search_tblKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_c_search_tblKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_c_search_tblKeyTyped
