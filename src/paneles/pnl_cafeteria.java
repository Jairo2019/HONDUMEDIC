 ...
 * @author Rojeru San
 */
public class pnl_cafeteria extends javax.swing.JInternalFrame {
Connection con=null;
Date dato = null;
ResultSet rs=null;
PreparedStatement pst=null;
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/shop_64.png"))); // NOI18N
        jLabel7.setText("Cafetería");
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/shop_64.png"))); // NOI18N
        jLabel14.setText("Cafetería");
    ...
    private void Reset()
{
    ...
    private void c_search_tblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_c_search_tblKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("SELECT * FROM servicio_ambulancia WHERE nombre LIKE '%"+name+"%' ");
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        try{
            ...
            String sql= "insert into servicio_ambulancia(nombre,descripcion,precio) values ('"+txtName.getText()+"','" + txtDescripcion.getText() +"','" +txtPrecio.getText()+ "')";
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try
        {
            ...
            if (P==0)
            {
                ...
                String sql= "delete from servicio_ambulancia where codigo_ambulancia= '" + txtCodigo.getText() + "'";
                pst=con.prepareStatement(sql);
                //        pst.execute();
