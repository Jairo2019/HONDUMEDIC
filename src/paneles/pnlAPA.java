 ...
 * @author RojeruSan
 */
public class pnlAPA extends javax.swing.JPanel {
Connection con=null;
Date dato = null;
ResultSet rs=null;
...
private void Get_Data(){
        String sql="select codigo_unidad_apa as 'Codigo', nombre as 'Nombre', descripcion as 'Descripción', precio as 'Precio' from unidad_apa";
        try{
    ...
    private void Reset()
{
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/APA_64.png"))); // NOI18N
        jLabel7.setText("Atención Primaria para Adulto");
        ...
        tableUsers.setFont(new java.awt.Font("Rockwell", 0, 12)); // NOI18N
        ...
        btnsave.setIcon(new javax.swing.ImageIcon("C:\\Users\\Jean Martell\\Desktop\\HospitalInfantil\\Icons\\Save_32.png")); // NOI18N
        ...
        btncancel.setIcon(new javax.swing.ImageIcon("C:\\Users\\Jean Martell\\Desktop\\HospitalInfantil\\Icons\\cancel1_32.png")); // NOI18N
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/APA_64.png"))); // NOI18N
        jLabel14.setText("Atención Primaria para Adulto");
        ...
        jTabbedPane2.addTab("Nuevo Servico APA", jPanel3);
    ...
    private void c_search_tblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_c_search_tblKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("SELECT * FROM unidad_apa WHERE nombre LIKE '%"+name+"%' ");
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        try{
            ...
            String sql= "insert into unidad_apa(nombre,descripcion,precio) values ('"+txtName.getText()+"','" + txtDescripcion.getText() +"','" +txtPrecio.getText()+ "')";

            pst=con.prepareStatement(sql);
            pst.execute();

            JOptionPane.showMessageDialog(this,"Registrado con éxito","Servicio Unidad APA",JOptionPane.INFORMATION_MESSAGE);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        try{
            con=Conexion.ConnectDB();
            String sql= "update unidad_apa set nombre='"+ txtName.getText()+ "',descripcion='" + txtDescripcion.getText() + "',precio='" + txtPrecio.getText() + "' where codigo_unidad_apa='" + txtCodigo.getText()+ "'";
            pst=con.prepareStatement(sql);
            pst.execute();
            JOptionPane.showMessageDialog(this,"Servico Actualizado","Servicio de Unidad APA",JOptionPane.INFORMATION_MESSAGE);
            btnUpdate.setEnabled(false);
            this.jTabbedPane2.setSelectedIndex(0);
            Get_Data();
            Reset();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try
        {
            ...
            if (P==0)
            {
                ...
                String sql= "delete from unidad_apa where codigo_unidad_apa= '" + txtCodigo.getText() + "'";
                pst=con.prepareStatement(sql);
                //        pst.execute();
