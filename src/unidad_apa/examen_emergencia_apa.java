 ...
 * @author Rojeru San
 */
public class examen_emergencia_apa extends javax.swing.JInternalFrame {
...
void sum_ingreso(){
     ...
     void edit_ingreso(){
         ...
         String sql= "UPDATE test_emergencia_apa set total ='"+total+"' where codigo='"+numFac.getText()+"'";
         try{
            con=Conexion.ConnectDB();
            pst=con.prepareStatement(sql);
            pst.execute();
...
//eliminar registro mal ingresado 
    ...
    private void btns_pacienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btns_pacienteActionPerformed
        pacientes.lista_pacientes_laboratorio.cual="10";
