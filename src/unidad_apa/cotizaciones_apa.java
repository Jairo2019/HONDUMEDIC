 ...
 * @author Rojeru San
 */
public class cotizaciones_apa extends javax.swing.JInternalFrame {
...
static Conexion cc = new Conexion();
 ...
 int filas;
    ...
    private void initComponents() {
        ...
        jPanel8.add(btnservicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 30, 190, 48));
    ...
    private void numeros() {
        ...
        String num = "";
        String c = "";
        String SQL = "SELECT MAX(codigo) FROM cotizaciones_apa";
        try {
...
// llenar la datos del reporte de la cotizacion
    ...
    private void c_search_tblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_c_search_tblKeyReleased
        ...
        try {
            ...
            Statement s = Conexion.ConnectDB().createStatement();
                ResultSet rs = s.executeQuery("SELECT * FROM cotizaciones_apa WHERE paciente LIKE '%"+name+"%' ");
    ...
    private void btnservicioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnservicioActionPerformed
         new elegir.elegir_servicio_cotizacion_apa(a, true).setVisible(true);        // TODO add your handling code here:
    }//GEN-LAST:event_btnservicioActionPerformed

    private void btnempleadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnempleadoActionPerformed
        empleados.lista_empleados_mindica.cual="8";
