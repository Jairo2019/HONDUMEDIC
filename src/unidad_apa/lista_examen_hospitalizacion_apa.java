 ...
 * @author Rojeru San
 */
public class lista_examen_hospitalizacion_apa extends javax.swing.JDialog {
...
public static Double value ;
    public lista_examen_hospitalizacion_apa(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
 ...
 private void Get_Data(){
        String sql="select codigo as 'Codigo',paciente as 'Paciente',medico_1 as 'Realizo Examen', num_habitacion as 'Habitación',observaciones as'Observaciones',fecha as 'Fecha y Hora', total as 'Total (L)' from test_hospitalizacion_apa";
    ...
    public void calcular() {
        ...
        for (int i = 0; i < caja_apa.tablaCaja.getRowCount(); i++) {
            pre = caja_apa.tablaCaja.getValueAt(i, 2).toString();
            can = caja_apa.tablaCaja.getValueAt(i, 3).toString();
            precio = Double.parseDouble(pre);
            cantidad = Integer.parseInt(can);
            imp = precio * cantidad;
            total = total + imp;
            double value = Double.valueOf(caja_apa.isv.getText());
            isv=((value/100) * total);
            caja_apa.tablaCaja.setValueAt(Math.rint(imp * 100) / 100, i, 4);

        }
        caja_apa.lblsubtotal.setText("" + Math.rint((total) * 100) / 100);
        caja_apa.lblTotal.setText("" + Math.rint((total+isv) * 100) / 100);

    }
    private void show_detalle(){
        int fila = tabla.getSelectedRow();
        String cod = tabla.getValueAt(fila, 0).toString();
        String sql="select codigo as 'Codigo',p_s as 'Producto/Servicio',precio as 'Precio',cantidad as 'Cantidad',importe as 'Importe' from detalle_test_hospitalizacion_apa where idventa='" + cod + "' ";
        try{
         pst=con.prepareStatement(sql);
         rs= pst.executeQuery();
         caja_apa.tablaCaja.setModel(DbUtils.resultSetToTableModel(rs));
         }catch(Exception e){
            JOptionPane.showMessageDialog(null, e);
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("select codigo as 'Codigo',paciente as 'Paciente',medico_1 as 'Realizo Examen', num_habitacion as 'Habitación',observaciones as'Observaciones',fecha as 'Fecha y Hora', total as 'Total (L)' from test_hospitalizacion_apa WHERE paciente LIKE '%"+name+"%' ");
            ...
            try {
                ...
                if (fila == -1) {
                    ...
                    String paciente = tabla.getValueAt(fila, 1).toString();
                            String com = caja_apa.codetest.getText();
                            if (cod.equals(com)) {
                                ErrorAlert er = new ErrorAlert(new JFrame(), true);
                                er.titulo.setText("OOPS...");
                                er.msj.setText("EL REGISTRO");
                                er.msj1.setText("YA SE INGRESO");
                                er.setVisible(true);
                                this.dispose();
                            }else{
                            caja_apa.codetest.setText(cod); 
                            caja_apa.txtpaciente.setText(paciente); 
                            caja_apa.txtcredito.setEnabled(true);
                            caja_apa.lblknowdetail.setText("H");
                            show_detalle();
                            calcular();
                            this.dispose();
                            }          
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_examen_hospitalizacion_apa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_examen_hospitalizacion_apa dialog = new lista_examen_hospitalizacion_apa(new javax.swing.JFrame(), true);
