 ...
 * @author Rojeru San
 */
public class productos_emergencia_apa extends javax.swing.JDialog {
...
PreparedStatement pst=null;
    public productos_emergencia_apa(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
 ...
 private void Get_Data(){
        String sql="select codigo_emergencia as 'Codigo', nombre as 'Nombre', precio as 'Precio', cantidad as 'Cantidad Disponible' from inventario_emergencia_apa";
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("select codigo_emergencia as 'Codigo', nombre as 'Nombre', precio as 'Precio', cantidad as 'Cantidad Disponible' from inventario_emergencia_apa WHERE nombre LIKE '%"+name+"%' ");
...
//                        actualizar_stock(total);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(productos_emergencia_apa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                productos_emergencia_apa dialog = new productos_emergencia_apa(new javax.swing.JFrame(), true);
