 ...
 * @author Rojeru San
 */
public class lista_cotizacion_hospitalizacion_apa extends javax.swing.JDialog {
...
public static String cual="";
    public lista_cotizacion_hospitalizacion_apa(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
 ...
 private void Get_Data(){
    ...
    private void btnMenosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMenosActionPerformed
        if (tabla.getRowCount() > 0) {
            try {
                DefaultTableModel tabladet = (DefaultTableModel)unidad_apa.cotizaciones_apa.tablaCaja.getModel();
                ...
                if (fila == -1) {
                    ...
                    if (this.txtCantidad.getText().equals("")) {
                        ...
                        if (c == 0) {
                            ...
                            unidad_apa.cotizaciones_apa.tablaCaja.setModel(tabladet);
                            calcular();
                        }
                    }
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_cotizacion_hospitalizacion_apa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_cotizacion_hospitalizacion_apa dialog = new lista_cotizacion_hospitalizacion_apa(new javax.swing.JFrame(), true);
