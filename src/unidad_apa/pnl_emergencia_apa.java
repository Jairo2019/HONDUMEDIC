 ...
 * @author Rojeru San
 */
public class pnl_emergencia_apa extends javax.swing.JInternalFrame {
Connection con=null;
Date dato = null;
ResultSet rs=null;
...
public PrincipalAdministrador a ;
    ...
    private void Get_Data(){
        Reset();
        String sql="select codigo_emergencia as 'Codigo', nombre as 'Nombre', descripcion as 'Descripción', precio as 'Precio' from servicio_emergencia_apa";
        try{
    ...
    private void Reset()
{
    ...
    private void c_search_tblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_c_search_tblKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("SELECT * FROM servicio_emergencia_apa WHERE nombre LIKE '%"+name+"%' ");
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        try{
            con=Conexion.ConnectDB();
            String sql= "update servicio_emergencia_apa set nombre='"+ txtName.getText()+ "',descripcion='" + txtDescripcion.getText() + "',precio='" + txtPrecio.getText() + "' where codigo_emergencia='" + txtCodigo.getText()+ "'";
            pst=con.prepareStatement(sql);
            pst.execute();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try
        {
            ...
            if (P==0)
            {
                ...
                String sql= "delete from servicio_emergencia_apa where codigo_emergencia= '" + txtCodigo.getText() + "'";
                pst=con.prepareStatement(sql);
                //        pst.execute();
