 ...
 * @author Rojeru San
 */
public class productos_ambulancia extends javax.swing.JDialog {
...
PreparedStatement pst=null;
 ...
 private void Get_Data(){
        String sql="select codigo_ambulancia as 'Codigo', nombre as 'Nombre', precio as 'Precio', cantidad as 'Cantidad Disponible' from inventario_ambulancia";
    ...
    public void calcular() {
        ...
        for (int i = 0; i < ambulancia.ambulancia.tablaCaja.getRowCount(); i++) {
            pre = ambulancia.ambulancia.tablaCaja.getValueAt(i, 2).toString();
            can = ambulancia.ambulancia.tablaCaja.getValueAt(i, 3).toString();
            precio = Double.parseDouble(pre);
            cantidad = Integer.parseInt(can);
            imp = precio * cantidad;
            total = total + imp;
            ambulancia.ambulancia.tablaCaja.setValueAt(Math.rint(imp * 100) / 100, i, 4);

        }
        ambulancia.ambulancia.lblTotal.setText("" + Math.rint((total) * 100) / 100);
    ...
    private void btnMenosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMenosActionPerformed
        if (tabla.getRowCount() > 0) {
            try {
                String cant = null;
                DefaultTableModel tabladet = (DefaultTableModel) ambulancia.ambulancia.tablaCaja.getModel();
                ...
                if (fila == -1) {
                    ...
                    if (this.txtCantidad.getText().equals("") || this.txtCantidad.getText().equals("0") ) {
                        ...
                        for (int i = 0; i < ambulancia.ambulancia.tablaCaja.getRowCount(); i++) {
                            Object com = ambulancia.ambulancia.tablaCaja.getValueAt(i, 0);
                            Object cant1 = ambulancia.ambulancia.tablaCaja.getValueAt(i, 3);
                            if (cod.equals(com)) {
                                j = i;
                                ...
                                if (cantT > ct) {
                                    ...
                                    ambulancia.ambulancia.tablaCaja.setValueAt(String.valueOf(cantT), i, 3);
                                    c=1;
                                    calcular();
...
//                        actualizar_stock(total);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(productos_ambulancia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                productos_ambulancia dialog = new productos_ambulancia(new javax.swing.JFrame(), true);
