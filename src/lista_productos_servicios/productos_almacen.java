 ...
 * @author Rojeru San
 */
public class productos_almacen extends javax.swing.JDialog {
...
PreparedStatement pst=null;
    public productos_almacen(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        this.tabla.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent lse) {
                if (tabla.getSelectedRow() != -1) {
                    ...
                    cantidadAlmacen.setText(tabla.getValueAt(fila, 4).toString());
                }
            }
        });       
   }
 ...
 private void Get_Data(){
        ...
        try{
         ...
         lista_productos_servicios.ColorearFilas colorear=new lista_productos_servicios.ColorearFilas(4);
    ...
    public void calcular() {
        ...
        for (int i = 0; i < Inventarios.almacen.tabla_almacen.getRowCount(); i++) {
            pre = Inventarios.almacen.tabla_almacen.getValueAt(i, 2).toString();
            can = Inventarios.almacen.tabla_almacen.getValueAt(i, 3).toString();
            precio = Double.parseDouble(pre);
            cantidad = Integer.parseInt(can);
            imp = precio * cantidad;
            total = total + imp;
            Inventarios.almacen.tabla_almacen.setValueAt(Math.rint(imp * 100) / 100, i, 4);

        }
        Farmacia.caja_cobro.lblTotal.setText("" + Math.rint((total) * 100) / 100);
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("select codigo_almacen as 'Codigo', "
                + "Producto as 'Producto', "
                + "precio_venta as 'Precio', "
                + "descripcion as 'Descripción', "
                + "cantidad as 'Cantidad Disponible' "
                + "from almacen WHERE producto LIKE '%"+name+"%' ");
    ...
    private void btnMenosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMenosActionPerformed
        if (tabla.getRowCount() > 0) {
            try {
                String cant = null;
                DefaultTableModel tabladet = (DefaultTableModel) Inventarios.almacen.tabla_almacen.getModel();
                ...
                if (fila == -1) {
                    ...
                    if (this.txtCantidad.getText().equals("") || this.txtCantidad.getText().equals("0") ) {
                        ...
                        for (int i = 0; i < Inventarios.almacen.tabla_almacen.getRowCount(); i++) {
                            Object com = Inventarios.almacen.tabla_almacen.getValueAt(i, 0);
                            Object cant1 = Inventarios.almacen.tabla_almacen.getValueAt(i, 4);
                            if (cod.equals(com)) {
                                j = i;
                                ...
                                if (cantT > ct) {
                                    ...
                                    Inventarios.almacen.tabla_almacen.setValueAt(String.valueOf(cantT), i, 4);
                                    c=1;
                                    this.dispose();
...
//                        actualizar_stock(total);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                productos_almacen dialog = new productos_almacen(new javax.swing.JFrame(), true);
