 ...
 * @author Rojeru San
 */
public class inventario_ambulancia extends javax.swing.JInternalFrame {
Connection con=null;
Date dato = null;
ResultSet rs=null;
   ...
   extraerID();
    ...
    private void c_search_tblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_c_search_tblKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("SELECT * FROM inventario_ambulancia WHERE nombre LIKE '%"+name+"%' ");
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        try{
            con=Conexion.ConnectDB();
            String sql= "update inventario_ambulancia set nombre='"+ txtName.getText()+ "',precio='" + txtPrecio.getText() + "',descripcion='" + txtDescripcion.getText() +"',cantidad='" + txtcantidad.getText() + "' where codigo_ambulancia='" + txtCodigo.getText()+ "'";
            pst=con.prepareStatement(sql);
            pst.execute();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try
        {
            ...
            if (P==0)
            {
                ...
                String sql= "delete from inventario_ambulancia where codigo_ambulancia= '" + txtCodigo.getText() + "'";
                pst=con.prepareStatement(sql);
                //        pst.execute();
