 ...
 * @author Rojeru San
 */
public class inventario_hospitalizacion extends javax.swing.JInternalFrame {
Connection con=null;
Date dato = null;
ResultSet rs=null;
PreparedStatement pst=null;
     ...
     */
    public inventario_hospitalizacion() {
        initComponents();
...
private void Get_Data(){
        Reset();
        String sql="select codigo_hospitalizacion as 'Codigo', nombre as 'Nombre', descripcion as 'Descripción', precio as 'Precio', cantidad as 'Cantidad Disponible' from inventario_hospitalizacion";
        try{
    ...
    private void Reset()
{
    ...
    private void c_search_tblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_c_search_tblKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("SELECT * FROM inventario_hospitalizacion WHERE nombre LIKE '%"+name+"%' ");
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        try{
            ...
            String sql= "insert into inventario_hospitalizacion(codigo_hospitalizacion,nombre,precio,descripcion,cantidad) values ('"+txtCodigo.getText()+"','"+txtName.getText()+"','" + txtPrecio.getText() +"','" +txtDescripcion.getText()+ "','" +txtcantidad.getText()+ "')";
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        try{
            con=Conexion.ConnectDB();
            String sql= "update inventario_hospitalizacion set nombre='"+ txtName.getText()+ "',precio='" + txtPrecio.getText() + "',descripcion='" + txtDescripcion.getText() +"',cantidad='" + txtcantidad.getText() + "' where codigo_hospitalizacion='" + txtCodigo.getText()+ "'";
            pst=con.prepareStatement(sql);
            pst.execute();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try
        {
            ...
            if (P==0)
            {
                ...
                String sql= "delete from inventario_hospitalizacion where codigo_hospitalizacion= '" + txtCodigo.getText() + "'";
                pst=con.prepareStatement(sql);
                //        pst.execute();
