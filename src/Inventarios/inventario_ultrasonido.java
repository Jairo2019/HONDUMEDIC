 ...
 * @author Rojeru San
 */
public class inventario_ultrasonido extends javax.swing.JInternalFrame {
Connection con=null;
Date dato = null;
ResultSet rs=null;
PreparedStatement pst=null;
    ...
    private void initComponents() {
        ...
        gridBagConstraints.insets = new java.awt.Insets(54, 333, 0, 0);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(47, 35, 0, 326);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(18, 35, 0, 326);
        ...
        gridBagConstraints.ipady = 10;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(19, 35, 0, 326);
        ...
        gridBagConstraints.ipady = 10;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(12, 35, 34, 326);
...
private void Get_Data(){
        extraerID();
        String sql="select codigo_ultrasonido as 'Codigo', nombre as 'Nombre', descripcion as 'Descripción', precio as 'Precio', cantidad as 'Cantidad Disponible' from inventario_ultrasonido";
        try{
 ...
 public void extraerID() {
        ...
        try {
            ...
            if (c == null) {
                ...
                gen.generar(j);
                txtCodigo.setText("IU" + gen.serie());
   ...
   extraerID();
    ...
    private void c_search_tblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_c_search_tblKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("SELECT * FROM inventario_ultrasonido WHERE nombre LIKE '%"+name+"%' ");
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        try{
            ...
            String sql= "insert into inventario_ultrasonido(codigo_ultrasonido,nombre,precio,descripcion,cantidad) values ('"+txtCodigo.getText()+"','"+txtName.getText()+"','" + txtPrecio.getText() +"','" +txtDescripcion.getText()+ "','" +txtcantidad.getText()+ "')";

            pst=con.prepareStatement(sql);
            pst.execute();

            JOptionPane.showMessageDialog(this,"Registrado con éxito","Inventario Ultrasonido",JOptionPane.INFORMATION_MESSAGE);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        try{
            con=Conexion.ConnectDB();
            String sql= "update inventario_ultrasonido set nombre='"+ txtName.getText()+ "',precio='" + txtPrecio.getText() + "',descripcion='" + txtDescripcion.getText() +"',cantidad='" + txtcantidad.getText() + "' where codigo_ultrasonido='" + txtCodigo.getText()+ "'";
            pst=con.prepareStatement(sql);
            pst.execute();
            JOptionPane.showMessageDialog(this,"Producto Actualizado","Inventario de Ultrasonido",JOptionPane.INFORMATION_MESSAGE);
            btnUpdate.setEnabled(false);
            this.jTabbedPane2.setSelectedIndex(0);
            Get_Data();
            Reset();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try
        {
            ...
            if (P==0)
            {
                ...
                String sql= "delete from inventario_ultrasonido where codigo_ultrasonido= '" + txtCodigo.getText() + "'";
                pst=con.prepareStatement(sql);
                //        pst.execute();
