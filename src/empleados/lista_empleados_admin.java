 ...
 * @author Rojeru San
 */
public class lista_empleados_admin extends javax.swing.JDialog {
...
PreparedStatement pst=null;
    public lista_empleados_admin(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_empleados_admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_empleados_admin dialog = new lista_empleados_admin(new javax.swing.JFrame(), true);
