 ...
 * @author Rojeru San
 */
public class lista_empleados_mindica extends javax.swing.JDialog {
...
Date dato = null;
ResultSet rs=null;
public static String cual=""; //saber cual formularipo requiere info
PreparedStatement pst=null;
    public lista_empleados_mindica(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_empleados_mindica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_empleados_mindica dialog = new lista_empleados_mindica(new javax.swing.JFrame(), true);
