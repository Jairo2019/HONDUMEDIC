 ...
 * @author Rojeru San
 */
public class pnl_hospitalizacion extends javax.swing.JInternalFrame {
Connection con=null;
Date dato = null;
ResultSet rs=null;
...
public PrincipalAdministrador a ;
    ...
    private void Get_Data(){
        String sql="select codigo_hospitalizacion as 'Codigo', nombre as 'Nombre', descripcion as 'Descripción', precio as 'Precio' from servicio_hospitalizacion";
        try{
    ...
    private void Reset()
{
    ...
    private void reporte(){
        ...
        String path = "src\\reportes_servicios\\servicios_hospitalizacion.jasper"; //Ponemos la localizacion del reporte creado
        try {
    ...
    private void c_search_tblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_c_search_tblKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("SELECT * FROM servicio_hospitalizacion WHERE nombre LIKE '%"+name+"%' ");
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try
        {
            ...
            if (P==0)
            {
                ...
                String sql= "delete from servicio_hospitalizacion where codigo_hospitalizacion= '" + txtCodigo.getText() + "'";
                pst=con.prepareStatement(sql);
                //        pst.execute();
