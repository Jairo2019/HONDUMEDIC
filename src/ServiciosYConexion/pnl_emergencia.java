 ...
 * @author Rojeru San
 */
public class pnl_emergencia extends javax.swing.JInternalFrame {
Connection con=null;
Date dato = null;
ResultSet rs=null;
...
public PrincipalAdministrador a ;
    ...
    private void initComponents() {
        ...
        jTabbedPane2.addTab("Servicios", jPanel10);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(jTabbedPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 1043, Short.MAX_VALUE)
        );
    ...
    private void Get_Data(){
        Reset();
        String sql="select codigo_emergencia as 'Codigo', nombre as 'Nombre', descripcion as 'Descripción', precio as 'Precio' from servicio_emergencia";
        try{
    ...
    private void Reset()
{
    ...
    private void reporte(){
        ...
        String path = "src\\reportes_servicios\\servicios_emergencia.jasper"; //Ponemos la localizacion del reporte creado
        try {
    ...
    private void c_search_tblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_c_search_tblKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("SELECT * FROM servicio_emergencia WHERE nombre LIKE '%"+name+"%' ");
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        try{
            ...
            String sql= "insert into servicio_emergencia(codigo_emergencia,nombre,descripcion,precio) values ('"+txtCodigo.getText()+"','" +txtName.getText()+"','" + txtDescripcion.getText() +"','" +txtPrecio.getText()+ "')";

            pst=con.prepareStatement(sql);
            pst.execute();

            JOptionPane.showMessageDialog(this,"Registrado con éxito","Servicio Emergencia",JOptionPane.INFORMATION_MESSAGE);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try
        {
            ...
            if (P==0)
            {
                ...
                String sql= "delete from servicio_emergencia where codigo_emergencia= '" + txtCodigo.getText() + "'";
                pst=con.prepareStatement(sql);
                //        pst.execute();
