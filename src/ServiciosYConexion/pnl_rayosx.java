 ...
 * @author Rojeru San
 */
public class pnl_rayosx extends javax.swing.JInternalFrame {
Connection con=null;
Date dato = null;
ResultSet rs=null;
...
public PrincipalAdministrador a ;
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jPanel9, javax.swing.GroupLayout.DEFAULT_SIZE, 1029, Short.MAX_VALUE)))
        );
 ...
 private void Get_Data(){
     Reset();
        String sql="select codigo_rayosx as 'Codigo', nombre as 'Nombre', descripcion as 'Descripción', precio as 'Precio' from servicio_rayosx";
        try{
    ...
    private void Reset()
{
    ...
    private void reporte(){
        ...
        String path = "src\\reportes_servicios\\servicios_rayosx.jasper"; //Ponemos la localizacion del reporte creado
        try {
    ...
    private void c_search_tblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_c_search_tblKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("SELECT * FROM servicio_rayosx WHERE nombre LIKE '%"+name+"%' ");
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        try{
            con=Conexion.ConnectDB();
            String sql= "update servicio_rayosx set nombre='"+ txtName.getText()+ "',descripcion='" + txtDescripcion.getText() + "',precio='" + txtPrecio.getText() + "' where codigo_rayosx='" + txtCodigo.getText()+ "'";
            pst=con.prepareStatement(sql);
            pst.execute();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try
        {
            ...
            if (P==0)
            {
                ...
                String sql= "delete from servicio_rayosx where codigo_rayosx= '" + txtCodigo.getText() + "'";
                pst=con.prepareStatement(sql);
                //        pst.execute();
