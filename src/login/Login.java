...
PreparedStatement pst=null;
    ...
    private void initComponents() {
        ...
        panel1.setColorPrimario(new java.awt.Color(0, 111, 177));
        panel1.setColorSecundario(new java.awt.Color(0, 111, 177));
        ...
        txtUserName.setPlaceholder("USUARIO");
        ...
        btnenter.setToolTipText("<html> <head> <style> #contenedor{background:white;color:black; padding-left:10px;padding-right:10px;margin:0; padding-top:5px;padding-bottom:5px;} </style> </head> <body> <h4 id=\"contenedor\">Iniciar sesión</h4> </body> </html>");
        btnenter.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnenter.setFont(new java.awt.Font("Roboto Medium", 1, 18)); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btnenter, javax.swing.GroupLayout.DEFAULT_SIZE, 430, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btnenter, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private principal.MaterialButtomRectangle btnenter;
    ...
    public static app.bolivia.swing.JCTextField txtUserName;
