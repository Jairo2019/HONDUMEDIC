 ...
 * @author Rojeru San
 */
public class lista_pacientes_hospitalizados extends javax.swing.JDialog {
...
PreparedStatement pst=null;
    public lista_pacientes_hospitalizados(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//String hola= cual;//saber de donde viene la petición para poder enviar información
        ...
        if (tabla.getRowCount() > 0) {
            try {
                ...
                if (fila == -1) {
                    ...
                    Registro_Salida.salida_hospitalizacion.lblcodigo.setText(cod);
                    this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_pacientes_hospitalizados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_pacientes_hospitalizados dialog = new lista_pacientes_hospitalizados(new javax.swing.JFrame(), true);
