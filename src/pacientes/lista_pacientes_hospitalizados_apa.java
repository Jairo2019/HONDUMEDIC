 ...
 * @author Rojeru San
 */
public class lista_pacientes_hospitalizados_apa extends javax.swing.JDialog {
...
PreparedStatement pst=null;
    public lista_pacientes_hospitalizados_apa(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        send.setText("Agregar Paciente");
        jPanel1.add(send, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 80, 150, 40));
    ...
    private void Get_Data(){
        String sql="select codigo as 'Codigo', Paciente as 'Paciente', medico_1 as 'Medico que lo Atendio', fecha as 'Fecha y Hora de Ingreso' from test_hospitalizacion_apa where estado=1";
...
//String hola= cual;//saber de donde viene la petición para poder enviar información
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("select codigo as 'Codigo', Paciente as 'Paciente', medico_1 as 'Medico que lo Atendio', fecha as 'Fecha y Hora de Ingreso' from test_hospitalizacion_apa where paciente LIKE '%"+name+"%' and  estado=1");
...
//                v.add(rs.getString(5));
        ...
        if (tabla.getRowCount() > 0) {
            try {
                ...
                if (fila == -1) {
                    ...
                    int c = 0;
                    int j = 0;
                    unidad_apa.salida_hospitalizacion_apa.txtpaciente.setText(nom);
                    unidad_apa.salida_hospitalizacion_apa.lblcodigo.setText(cod);
                    this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_pacientes_hospitalizados_apa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_pacientes_hospitalizados_apa dialog = new lista_pacientes_hospitalizados_apa(new javax.swing.JFrame(), true);
