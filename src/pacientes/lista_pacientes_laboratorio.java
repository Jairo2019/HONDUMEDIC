 ...
 * @author Rojeru San
 */
public class lista_pacientes_laboratorio extends javax.swing.JDialog {
...
PreparedStatement pst=null;
    public lista_pacientes_laboratorio(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//query buscar por identidad, nombre o appellido al paciente
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_pacientes_laboratorio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_pacientes_laboratorio dialog = new lista_pacientes_laboratorio(new javax.swing.JFrame(), true);
