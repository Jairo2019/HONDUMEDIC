 ...
 * @author Rojeru San
 */
public class lista_caja_ultrasonido extends javax.swing.JDialog {
...
public static Double value ;
    public lista_caja_ultrasonido(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
 ...
 private void Get_Data(){
    ...
    public void calcular() {
        ...
        for (int i = 0; i < examen_ultrasonido.tablaCaja.getRowCount(); i++) {
            pre = examen_ultrasonido.tablaCaja.getValueAt(i, 2).toString();
            can = examen_ultrasonido.tablaCaja.getValueAt(i, 3).toString();
            precio = Double.parseDouble(pre);
            cantidad = Integer.parseInt(can);
            imp = precio * cantidad;
            total = total + imp;
            examen_ultrasonido.tablaCaja.setValueAt(Math.rint(imp * 100) / 100, i, 4);

        }
        examen_ultrasonido.lblTotal.setText("" + Math.rint((total) * 100) / 100);
    ...
    private void show_detalle(){
        ...
        String sql="select codigo as 'Codigo',"
                ...
                + "importe as 'Importe' "
                + "from detalle_test_ultrasonido where idventa='" + cod + "' ";
        try{
         pst=con.prepareStatement(sql);
         rs= pst.executeQuery();
         examen_ultrasonido.tablaCaja.setModel(DbUtils.resultSetToTableModel(rs));
         }catch(Exception e){
            JOptionPane.showMessageDialog(null, e);
            ...
            try {
                ...
                if (fila == -1) {
                    ...
                    String paciente = tabla.getValueAt(fila, 2).toString();
                            String com = examen_ultrasonido.codetest.getText();
                            if (cod.equals(com)) {
                                ErrorAlert er = new ErrorAlert(new JFrame(), true);
                                er.titulo.setText("OOPS...");
                            ...
                            examen_ultrasonido.codetest.setText(cod);
                            examen_ultrasonido.lblidpaciente.setText(idpaciente);
                            examen_ultrasonido.txtpaciente.setText(paciente); 
                            show_detalle();
                            calcular();
                            this.dispose();
                            }          
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_caja_ultrasonido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_caja_ultrasonido dialog = new lista_caja_ultrasonido(new javax.swing.JFrame(), true);
