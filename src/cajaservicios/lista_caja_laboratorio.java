...
public static Double value ;
 ...
 private void Get_Data(){
    ...
    public void calcular() {
        ...
        for (int i = 0; i < examen_laboratorio.tablaCaja.getRowCount(); i++) {
            pre = examen_laboratorio.tablaCaja.getValueAt(i, 2).toString();
            can = examen_laboratorio.tablaCaja.getValueAt(i, 3).toString();
            precio = Double.parseDouble(pre);
            cantidad = Integer.parseInt(can);
            imp = precio * cantidad;
            total = total + imp;
            examen_laboratorio.tablaCaja.setValueAt(Math.rint(imp * 100) / 100, i, 4);

        }
        examen_laboratorio.lblTotal.setText("" + Math.rint((total) * 100) / 100);
    ...
    private void show_detalle(){
        ...
        try{
         pst=con.prepareStatement(sql);
         rs= pst.executeQuery();
         examen_laboratorio.tablaCaja.setModel(DbUtils.resultSetToTableModel(rs));
         }catch(Exception e){
            JOptionPane.showMessageDialog(null, e);
            ...
            try {
                ...
                if (fila == -1) {
                    ...
                    String paciente = tabla.getValueAt(fila, 2).toString();
                            String com = examen_laboratorio.codetest.getText();
                            if (cod.equals(com)) {
                                ErrorAlert er = new ErrorAlert(new JFrame(), true);
                                er.titulo.setText("OOPS...");
                            ...
                            examen_laboratorio.codetest.setText(cod);
                            examen_laboratorio.lblidpaciente.setText(idpaciente);
                            examen_laboratorio.txtpaciente.setText(paciente); 
                            show_detalle();
                            calcular();
                            this.dispose();
                            }          
