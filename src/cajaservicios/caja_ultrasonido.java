 ...
 * @author Rojeru San
 */
public class caja_ultrasonido extends javax.swing.JInternalFrame {
...
static Conexion cc = new Conexion();
 ...
 int filas;
    ...
    private void numeros() {
        ...
        String num = "";
        String c = "";
        String SQL = "SELECT MAX(idventa) FROM caja_ultrasonido";
        try {
...
//actualiza la cantidad  
    void actualizarStock() {
     ...
     void sum_ingreso(){
         try{
         String sql= "select sum(importe) FROM caja_ultrasonido WHERE idventa='"+numFac.getText()+"'";
     ...
     void edit_ingreso(){
         ...
         String sql= "UPDATE caja_ultrasonido set total ='"+total+"' where codigo='"+numFac.getText()+"'";
         try{
            con=Conexion.ConnectDB();
            pst=con.prepareStatement(sql);
            pst.execute();
...
private void edit_detalle(){
    for (int i = 0; i <tablaCaja.getRowCount(); i++) {
        ...
        String sql= "insert into caja_ultrasonido(idventa,"
                + "codigo,"
                + "id_paciente,"
                + "p_s,"
                + "precio,"
    ...
    private void show_detalle(){
        String sql="select codigo as 'Codigo',"
                ...
                + "importe as 'Importe' "
                + "from detalle_test_ultrasonido where idventa='" + numFac.getText() + "' and estado=1";
        try{
         pst=con.prepareStatement(sql);
         rs= pst.executeQuery();
...
private void condicionPaciente( ){
    ...
    private void btnVender1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVender1ActionPerformed
        new lista_productos_servicios.productos_ultrasonido(new JFrame(), true).setVisible(true);
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
        ...
        try{
            ...
            String sql= "insert into caja_ultrasonido("
                    + "paciente,"
                    + "fecha,"
                    + "total,"
                    + "estado) values ('" 
    ...
    private void btnserviciosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnserviciosActionPerformed
        new lista_servicios.lista_ultrasonido(new JFrame(), true).setVisible(true);        // TODO add your handling code here:
