 ...
 * @author Rojeru San
 */
public class lista_caja_rayosx extends javax.swing.JDialog {
...
public static Double value ;
    public lista_caja_rayosx(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
 ...
 private void Get_Data(){
    ...
    public void calcular() {
        ...
        for (int i = 0; i < examen_rayosx.tablaCaja.getRowCount(); i++) {
            pre = examen_rayosx.tablaCaja.getValueAt(i, 2).toString();
            can = examen_rayosx.tablaCaja.getValueAt(i, 3).toString();
            precio = Double.parseDouble(pre);
            cantidad = Integer.parseInt(can);
            imp = precio * cantidad;
            total = total + imp;
            examen_rayosx.tablaCaja.setValueAt(Math.rint(imp * 100) / 100, i, 4);

        }
        examen_rayosx.lblTotal.setText("" + Math.rint((total) * 100) / 100);
    ...
    private void show_detalle(){
        ...
        try{
         pst=con.prepareStatement(sql);
         rs= pst.executeQuery();
         examen_rayosx.tablaCaja.setModel(DbUtils.resultSetToTableModel(rs));
         }catch(Exception e){
            JOptionPane.showMessageDialog(null, e);
            ...
            try {
                ...
                if (fila == -1) {
                    ...
                    String paciente = tabla.getValueAt(fila, 2).toString();
                            String com = examen_rayosx.codetest.getText();
                            if (cod.equals(com)) {
                                ErrorAlert er = new ErrorAlert(new JFrame(), true);
                                er.titulo.setText("OOPS...");
                            ...
                            examen_rayosx.codetest.setText(cod);
                            examen_rayosx.lblidpaciente.setText(idpaciente);
                            examen_rayosx.txtpaciente.setText(paciente); 
                            show_detalle();
                            calcular();
                            this.dispose();
                            }          
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_caja_rayosx.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_caja_rayosx dialog = new lista_caja_rayosx(new javax.swing.JFrame(), true);
