...
static Conexion cc = new Conexion();
 ...
 int filas;
    ...
    private void initComponents() {
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/previous_48.png"))); // NOI18N
...
//actualiza la cantidad  
    void actualizarStock() {
     ...
     void sum_ingreso(){
         try{
         String sql= "select sum(importe) FROM caja_laboratorio WHERE idventa='"+numFac.getText()+"'";
     ...
     void edit_ingreso(){
         ...
         String sql= "UPDATE caja_laboratorio set total ='"+total+"' where codigo='"+numFac.getText()+"'";
         try{
            con=Conexion.ConnectDB();
            pst=con.prepareStatement(sql);
            pst.execute();
