...
import static reportes_registros.lista_examen_rayosx.tabla;
 ...
 * @author Rojeru San
 */
public class lista_examen_ultrasonido extends javax.swing.JDialog {
...
public static Double value ;
    public lista_examen_ultrasonido(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        btnambulancia1 = new principal.MaterialButtomRectangle();
        ...
        btnambulancia1.setBackground(new java.awt.Color(0, 111, 177));
        btnambulancia1.setForeground(new java.awt.Color(255, 255, 255));
        btnambulancia1.setText("imprimir");
        btnambulancia1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnambulancia1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btnambulancia1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnambulancia1ActionPerformed(evt);
            }
        });
        jPanel1.add(btnambulancia1, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 70, 170, 55));
 ...
 private void Get_Data(){
        String sql="select codigo as 'Codigo',"
                ...
                + "total as 'Total (L)' from test_ultrasonido";
     ...
     void print_bill(){
        ...
        String path = "src\\reportes_registros\\rpt_ultrasonido.jasper"; //Ponemos la localizacion del reporte creado
        try {
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("select codigo as 'Codigo',"
                    ...
                    + "fecha as 'Fecha y Hora', "
                    + "total as 'Total (L)' "
                    + "from test_ultrasonido WHERE paciente LIKE '%"+name+"%' ");
    ...
    private void btnambulancia1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnambulancia1ActionPerformed
        this.dispose();
        print_bill();
    }//GEN-LAST:event_btnambulancia1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_examen_ultrasonido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_examen_ultrasonido dialog = new lista_examen_ultrasonido(new javax.swing.JFrame(), true);
    ...
    private principal.MaterialButtomRectangle btnambulancia1;
