...
public static Double value ;
    ...
    private void initComponents() {
        ...
        btnprint = new principal.MaterialButtomRectangle();
        ...
        jPanel1.add(btnprint, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 70, 170, 55));
 ...
 private void Get_Data(){
  ...
  //codigo,paciente, medico, habitacion,observaciones, fecha, total
     void print_bill(){
        ...
        String path = "src\\reportes_registros\\rpt_emergencia_apa.jasper"; //Ponemos la localizacion del reporte creado
        try {
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("select codigo as 'Codigo',"
                    ...
                    + "observaciones as'Observaciones',"
                    + "fecha as 'Fecha y Hora', "
                    + "total as 'Total (L)' from test_emergencia_apa WHERE paciente LIKE '%"+name+"%' ");
    ...
    private principal.MaterialButtomRectangle btnprint;
