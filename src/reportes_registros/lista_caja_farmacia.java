 ...
 * @author Rojeru San
 */
public class lista_caja_farmacia extends javax.swing.JDialog {
...
public static Double value ;
    public lista_caja_farmacia(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
"              from caja_farmacia";
 ...
 void print_bill(){
        ...
        String path = "src\\reportes_registros\\rpt_caja_farmacia.jasper"; //Ponemos la localizacion del reporte creado
        try {
...
"              from caja_farmacia WHERE cliente LIKE '%"+name+"%' ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_caja_farmacia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_caja_farmacia dialog = new lista_caja_farmacia(new javax.swing.JFrame(), true);
