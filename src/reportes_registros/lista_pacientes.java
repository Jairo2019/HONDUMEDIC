 ...
 * @author Rojeru San
 */
public class lista_pacientes extends javax.swing.JDialog {
...
PreparedStatement pst=null;
    public lista_pacientes(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
  ...
  void print_bill(){
        class_pacientes em;// Instaciamos la clase empleado
        List <class_pacientes >lista = new ArrayList<>(); //Creamos una lista de empleados con ArrayList para obtener cada empleado
        for(int i=0; i<tabla.getRowCount(); i++){ // Iterena cada fila de la tabla
            em = new class_pacientes (tabla.getValueAt(i, 0).toString(),tabla.getValueAt(i,1).toString(), //Tomamos de la tabla el valor de cada columna y creamos un objeto 
        ...
        String path = "src\\reportes_registros\\rpt_pacientes.jasper"; //Ponemos la localizacion del reporte creado
        try {
...
//                v.add(rs.getString(5));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_pacientes dialog = new lista_pacientes(new javax.swing.JFrame(), true);
