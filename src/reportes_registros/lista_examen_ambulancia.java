...
import static reportes_registros.lista_examen_cirugia.tabla;
 ...
 * @author Rojeru San
 */
public class lista_examen_ambulancia extends javax.swing.JDialog {
...
public static Double value ;
    public lista_examen_ambulancia(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
"                	paciente = codigo_paciente";
 ...
 //codigo,paciente, medico, conductor,origen,destino, fecha, total;
      void print_bill(){
        ...
        String path = "src\\reportes_registros\\rpt_ambulancia.jasper"; //Ponemos la localizacion del reporte creado
        try {
...
"                	paciente = codigo_paciente WHERE CONCAT(nombre, ' ' , apellido) LIKE '%"+name+"%' or codigo LIKE '%"+name+"%' ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_examen_ambulancia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_examen_ambulancia dialog = new lista_examen_ambulancia(new javax.swing.JFrame(), true);
