 ...
 * @author Rojeru San
 */
public class lista_caja_cafeteria extends javax.swing.JDialog {
...
public static Double value ;
    public lista_caja_cafeteria(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
 ...
 void print_bill(){
        class_caja_cafeteria em;// Instaciamos la clase empleado
        List <class_caja_cafeteria>lista = new ArrayList<>(); //Creamos una lista de empleados con ArrayList para obtener cada empleado
        for(int i=0; i<tabla.getRowCount(); i++){ // Iterena cada fila de la tabla
            em = new class_caja_cafeteria(tabla.getValueAt(i, 0).toString(),tabla.getValueAt(i,1).toString(), //Tomamos de la tabla el valor de cada columna y creamos un objeto 
        ...
        String path = "src\\reportes_registros\\rpt_caja_cafeteria.jasper"; //Ponemos la localizacion del reporte creado
        try {
...
void between_date(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_caja_cafeteria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_caja_cafeteria dialog = new lista_caja_cafeteria(new javax.swing.JFrame(), true);
    ...
    private principal.MaterialButtomRectangle btnall;
