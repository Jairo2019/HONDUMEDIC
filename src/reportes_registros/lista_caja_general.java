 ...
 * @author Rojeru San
 */
public class lista_caja_general extends javax.swing.JDialog {
...
public static Double value ;
    public lista_caja_general(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
 ...
 }//codigo,paciente,estado, fecha, total
 void print_bill(){
        ...
        String path = "src\\reportes_registros\\rpt_caja_general.jasper"; //Ponemos la localizacion del reporte creado
        try {
  ...
  void between_date(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_caja_general.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_caja_general dialog = new lista_caja_general(new javax.swing.JFrame(), true);
