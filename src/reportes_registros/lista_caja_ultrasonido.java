...
public static Double value ;
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnshow, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 80, -1, 40));
 ...
 void print_bill(){
        ...
        String path = "src\\reportes_registros\\rpt_caja_ultrasonido.jasper"; //Ponemos la localizacion del reporte creado
        try {
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("select idventa as 'Codigo',"
                ...
                + "or and codigo_paciente LIKE '%"+name+"%' ");
