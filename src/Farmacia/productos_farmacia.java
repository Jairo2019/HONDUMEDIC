 ...
 * @author Rojeru San
 */
public class productos_farmacia extends javax.swing.JDialog {
...
PreparedStatement pst=null;
    public productos_farmacia(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
 ...
 private void Get_Data(){
    ...
    public void calcular() {
        ...
        for (int i = 0; i < Farmacia.caja_cobro.tablaCaja.getRowCount(); i++) {
            pre = Farmacia.caja_cobro.tablaCaja.getValueAt(i, 2).toString();
            can = Farmacia.caja_cobro.tablaCaja.getValueAt(i, 3).toString();
            precio = Double.parseDouble(pre);
            cantidad = Integer.parseInt(can);
            imp = precio * cantidad;
            total = total + imp;
            Farmacia.caja_cobro.tablaCaja.setValueAt(Math.rint(imp * 100) / 100, i, 4);
    ...
    private void btnMenosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMenosActionPerformed
        if (tabla.getRowCount() > 0) {
            try {
                String cant = null;
                DefaultTableModel tabladet = (DefaultTableModel) Farmacia.caja_cobro.tablaCaja.getModel();
                ...
                if (fila == -1) {
                    ...
                    if (this.txtCantidad.getText().equals("") || this.txtCantidad.getText().equals("0") ) {
                        ...
                        for (int i = 0; i < Farmacia.caja_cobro.tablaCaja.getRowCount(); i++) {
                            Object com = Farmacia.caja_cobro.tablaCaja.getValueAt(i, 0);
                            Object cant1 = Farmacia.caja_cobro.tablaCaja.getValueAt(i, 3);
                            if (cod.equals(com)) {
                                j = i;
                                ...
                                if (cantT > ct) {
                                    ...
                                    Farmacia.caja_cobro.tablaCaja.setValueAt(String.valueOf(cantT), i, 3);
                                    c=1;
                                    calcular();
...
//                        actualizar_stock(total);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(productos_farmacia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                productos_farmacia dialog = new productos_farmacia(new javax.swing.JFrame(), true);
