 ...
 * @author Rojeru San
 */
public class registrar_cirugia extends javax.swing.JInternalFrame {
...
static Conexion cc = new Conexion();
 ...
 int filas;
    ...
    private void initComponents() {
        ...
        txtayudante = new app.bolivia.swing.JCTextField();
        ...
        jPanel22.add(txtnumhabitacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 70, 240, 30));
        ...
        jPanel22.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, -1, -1));
        ...
        txtmedicoadmin.setPlaceholder("MEDICO QUE REALIZA");
        jPanel4.add(txtmedicoadmin, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 90, 240, 30));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/ventas/atiende.png"))); // NOI18N
        jPanel4.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 80, 310, -1));
        ...
        jPanel4.add(btns_admin, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 80, 80, 50));

        txtayudante.setEditable(false);
        txtayudante.setBorder(null);
        txtayudante.setForeground(new java.awt.Color(58, 159, 171));
        txtayudante.setToolTipText("");
        txtayudante.setEnabled(false);
        txtayudante.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtayudante.setPlaceholder("AYUDANTE");
        jPanel4.add(txtayudante, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 160, 240, 30));
        ...
        jPanel4.add(btns_medico1, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 150, 80, 50));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/ventas/indication.png"))); // NOI18N
        jPanel4.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 150, 310, -1));
  ...
  private void Get_Data(){
        limpiaCampos();
        String sql="select codigo as 'Codigo',paciente as 'Paciente', medico_1 as 'Realizo Examen', medico_2 as 'Indico Examen',num_habitacion as 'Habitación',observaciones as'Observaciones',fecha as 'Fecha y Hora', total as 'Total (L)' from test_cirugia";
        try{
    ...
    void actualizarStock() {
        for (int i = 0; i < tablaCaja.getRowCount(); i++) {
            ...
            pr = pdao.listarID_cirugia(idp);
            int sa = pr.getStock() - cant;
            pdao.actualizarStock_cirugia(sa, idp);

        }
    }
         void sum_ingreso(){
         try{
         String sql= "select sum(importe) FROM detalle_test_cirugia WHERE idventa='"+numFac.getText()+"'";
...
private void edit_detalle(){
    ...
    private void c_search_tblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_c_search_tblKeyReleased
        ...
        try {
            ...
            Statement s = Conexion.ConnectDB().createStatement();
                ResultSet rs = s.executeQuery("SELECT * FROM test_cirugia WHERE paciente LIKE '%"+name+"%' ");
    ...
    private void tableCajaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableCajaMouseClicked
        try {
            ...
            txtayudante.setText(tableCaja.getModel().getValueAt(row,3).toString()) ;
    ...
    private void btnVender1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVender1ActionPerformed
        new lista_productos_servicios.productos_cirugia(new JFrame(), true).setVisible(true);
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
        ...
        try{
            ...
            String sql= "insert into test_cirugia(codigo,paciente,medico_1,medico_2,num_habitacion,observaciones,fecha,total) values ('"+numFac.getText()+"','" +txtpaciente.getText()+"','" +txtmedicoadmin.getText()+"','" +txtayudante.getText()+"','"+txtnumhabitacion.getText()+"','" +txtdescripcion.getText()+"','" + txtFecha.getText()+"','" +lblTotal.getText() + "')";
            pst=con.prepareStatement(sql);
            pst.execute();
            actualizarStock(); 
            ingresar_detalle();
    ...
    private void btnserviciosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnserviciosActionPerformed
        new lista_servicios.lista_cirugia(new JFrame(), true).setVisible(true);        // TODO add your handling code here:
    ...
    private void btns_pacienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btns_pacienteActionPerformed
        pacientes.lista_pacientes_laboratorio.cual="6";
    ...
    private void btns_adminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btns_adminActionPerformed
        empleados.lista_empleados_admin.cual="6";
    ...
    private void btns_medico1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btns_medico1ActionPerformed
        empleados.lista_empleados_mindica.cual="6";
    ...
    public static app.bolivia.swing.JCTextField txtayudante;
