...
public static String tipo_usuario="";
 ...
 int filas;
    ...
    private void initComponents() {
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/previous_48.png"))); // NOI18N
        ...
        txtayudante.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jTabbedPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 636, Short.MAX_VALUE))
        );
   ...
   public static String fechaactual() {
    ...
    //opbter los datos de la tabla test_cirugia
    ...
    private String eliminar_registro(String codigo){
        try
        {
            ...
            if (P==0){
                ...
                String sql= "delete from detalle_test_cirugia where codigo= '" + codigo + "' and idventa = '"+ numFac.getText() + "'";
                pst=con.prepareStatement(sql);
                pst.execute();
...
//saber si el paciente ha hecho deposito
    ...
    private void tableCajaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableCajaMouseClicked
        try {
            ...
            txtayudante.setText(tableCaja.getModel().getValueAt(row,4).toString()) ;
