 ...
 * @author Rojeru San
 */
public class elegir_cafeteria extends javax.swing.JDialog {
     ...
     */
    public elegir_cafeteria(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(elegir_cafeteria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                elegir_cafeteria dialog = new elegir_cafeteria(new javax.swing.JFrame(), true);
