 ...
 * @author Rojeru San
 */
public class elegir_emergencia extends javax.swing.JDialog {
     ...
     */
    public elegir_emergencia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        btnservicios.setText("Servicios Pediátricos");
    ...
    private void btnserviciosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnserviciosActionPerformed
        ...
        this.dispose();
        if (PrincipalAdministrador.estacerrado(PrincipalAdministrador.servicio_emergencia)) {
            PrincipalAdministrador.servicio_emergencia = new pnl_emergencia();
            int width = PrincipalAdministrador.escritorio.getWidth();
            int Height = PrincipalAdministrador.escritorio.getHeight();
            PrincipalAdministrador.servicio_emergencia.setSize(width, Height);
            PrincipalAdministrador.escritorio.add(PrincipalAdministrador.servicio_emergencia);
            PrincipalAdministrador.servicio_emergencia.show();
        }
    ...
    private void btninventarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btninventarioActionPerformed
        PrincipalAdministrador.escritorio.removeAll();
        this.dispose();
        if (PrincipalAdministrador.estacerrado(PrincipalAdministrador.inventario_emergencia)) {
            PrincipalAdministrador.inventario_emergencia = new inventario_emergencia();
            int width = PrincipalAdministrador.escritorio.getWidth();
            int Height = PrincipalAdministrador.escritorio.getHeight();
            PrincipalAdministrador.inventario_emergencia.setSize(width, Height);
            PrincipalAdministrador.escritorio.add(PrincipalAdministrador.inventario_emergencia);
            PrincipalAdministrador.inventario_emergencia.show();   }     // TODO add your handling code here:
    }//GEN-LAST:event_btninventarioActionPerformed

    private void btnregistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnregistrarActionPerformed
        PrincipalAdministrador.escritorio.removeAll();
        this.dispose();
        if (PrincipalAdministrador.estacerrado(PrincipalAdministrador.examen_emergencia)) {
            PrincipalAdministrador.examen_emergencia = new examen_emergencia();
            int width = PrincipalAdministrador.escritorio.getWidth();
            int Height = PrincipalAdministrador.escritorio.getHeight();
            PrincipalAdministrador.examen_emergencia.setSize(width, Height);
            PrincipalAdministrador.escritorio.add(PrincipalAdministrador.examen_emergencia);
            PrincipalAdministrador.examen_emergencia.show();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(elegir_emergencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                elegir_emergencia dialog = new elegir_emergencia(new javax.swing.JFrame(), true);
