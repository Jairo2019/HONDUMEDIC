 ...
 * @author Rojeru San
 */
public class elegir_unidadapa extends javax.swing.JDialog {
     ...
     */
    public elegir_unidadapa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(elegir_unidadapa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                elegir_unidadapa dialog = new elegir_unidadapa(new javax.swing.JFrame(), true);
