 ...
 * @author Rojeru San
 */
public class elegir_cirugia extends javax.swing.JDialog {
     ...
     */
    public elegir_cirugia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(elegir_cirugia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                elegir_cirugia dialog = new elegir_cirugia(new javax.swing.JFrame(), true);
