 ...
 * @author Rojeru San
 */
public class elegir_hospitalizacion extends javax.swing.JDialog {
     ...
     */
    public elegir_hospitalizacion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnserviceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnserviceActionPerformed
        ...
        this.dispose();
        if (PrincipalAdministrador.estacerrado(PrincipalAdministrador.servicio_hospitalizacion)) {
            PrincipalAdministrador.servicio_hospitalizacion = new pnl_hospitalizacion();
            int width = PrincipalAdministrador.escritorio.getWidth();
            int Height = PrincipalAdministrador.escritorio.getHeight();
            PrincipalAdministrador.servicio_hospitalizacion.setSize(width, Height);
            PrincipalAdministrador.escritorio.add(PrincipalAdministrador.servicio_hospitalizacion);
            PrincipalAdministrador.servicio_hospitalizacion.show();
        }
    ...
    private void btninventaryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btninventaryActionPerformed
        PrincipalAdministrador.escritorio.removeAll();
        this.dispose();
        if (PrincipalAdministrador.estacerrado(PrincipalAdministrador.inventario_hospitalizacion)) {
            PrincipalAdministrador.inventario_hospitalizacion = new inventario_hospitalizacion();
            int width = PrincipalAdministrador.escritorio.getWidth();
            int Height = PrincipalAdministrador.escritorio.getHeight();
            PrincipalAdministrador.inventario_hospitalizacion.setSize(width, Height);
            PrincipalAdministrador.escritorio.add(PrincipalAdministrador.inventario_hospitalizacion);
            PrincipalAdministrador.inventario_hospitalizacion.show();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(elegir_hospitalizacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                elegir_hospitalizacion dialog = new elegir_hospitalizacion(new javax.swing.JFrame(), true);
