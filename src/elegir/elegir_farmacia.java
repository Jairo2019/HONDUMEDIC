 ...
 * @author Rojeru San
 */
public class elegir_farmacia extends javax.swing.JDialog {
     ...
     */
    public elegir_farmacia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(elegir_farmacia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                elegir_farmacia dialog = new elegir_farmacia(new javax.swing.JFrame(), true);
