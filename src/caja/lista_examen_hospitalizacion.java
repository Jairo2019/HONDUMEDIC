 ...
 * @author Rojeru San
 */
public class lista_examen_hospitalizacion extends javax.swing.JDialog {
...
public static Double value ;
    public lista_examen_hospitalizacion(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
 ...
 private void Get_Data(){
        String sql="select codigo as 'Codigo',paciente as 'Paciente',medico_1 as 'Realizo Examen', num_habitacion as 'Habitación',observaciones as'Observaciones',fecha as 'Fecha y Hora', total as 'Total (L)' from test_hospitalizacion";
    ...
    private void show_detalle(){
        ...
        String sql="select codigo as 'Codigo',p_s as 'Producto/Servicio',precio as 'Precio',cantidad as 'Cantidad',importe as 'Importe' from detalle_test_hospitalizacion where idventa='" + cod + "' ";
        try{
         pst=con.prepareStatement(sql);
         rs= pst.executeQuery();
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("select codigo as 'Codigo',paciente as 'Paciente',medico_1 as 'Realizo Examen', num_habitacion as 'Habitación',observaciones as'Observaciones',fecha as 'Fecha y Hora', total as 'Total (L)' from test_hospitalizacion WHERE paciente LIKE '%"+name+"%' ");
            ...
            try {
                ...
                if (fila == -1) {
                    ...
                    String paciente = tabla.getValueAt(fila, 1).toString();
                            String com = caja.codetest.getText();
                            if (cod.equals(com)) {
                                ErrorAlert er = new ErrorAlert(new JFrame(), true);
                                er.titulo.setText("OOPS...");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_examen_hospitalizacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_examen_hospitalizacion dialog = new lista_examen_hospitalizacion(new javax.swing.JFrame(), true);
