...
static Conexion cc = new Conexion();
 ...
 int filas;
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Estados de Cuenta");
        ...
        jLabel14.setText("Estados de Cuenta");
...
//           Logger.getLogger(opciones_serviciosVen.class.getName()).log(Level.SEVERE, null, ex);
  ...
  private void Get_Data(){
        ...
        estadosde_cuenta.txttotalcaja.setText("TOTAL EN CAJA: L " + Math.rint((total) * 100) / 100);
  }
  ...
  void cuentas_cobrar(){
        ...
        estadosde_cuenta.txttotalcaja.setText("TOTAL SALDO PENDIENTE: L " + Math.rint((total) * 100) / 100);
}
...
//        double disv= Double.parseDouble(isvr);
    ...
    void sales_date(){
       ...
       try {
        ...
        estadosde_cuenta.txttotalcaja.setText("TOTAL: L " + Math.rint((total) * 100) / 100);//rint (double to num entero)
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }          
...
// traer los detalles de la factura con el codigo del examen
    ...
    void subtotal(){
        ...
        estadosde_cuenta.lblsubtotal.setText("" + Math.rint((total) * 100) / 100);
    }
    ...
    private void c_search_tblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_c_search_tblKeyReleased
        ...
        try {
            ...
            if (thishide.isVisible()){
                ...
                estadosde_cuenta.txttotalcaja.setText("TOTAL: L " + Math.rint((total) * 100) / 100);
                    }
        }
