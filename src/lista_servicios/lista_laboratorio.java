 ...
 * @author Rojeru San
 */
public class lista_laboratorio extends javax.swing.JDialog {
...
PreparedStatement pst=null;
    public lista_laboratorio(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
 ...
 private void Get_Data(){
        String sql="select codigo_laboratorio as 'Codigo', nombre as 'Nombre', precio as 'Precio' from servicio_laboratorio";
    ...
    public void calcular() {
        ...
        for (int i = 0; i < registro_examen.examen_laboratorio.tablaCaja.getRowCount(); i++) {
            pre = registro_examen.examen_laboratorio.tablaCaja.getValueAt(i, 2).toString();
            can = registro_examen.examen_laboratorio.tablaCaja.getValueAt(i, 3).toString();
            precio = Double.parseDouble(pre);
            cantidad = Integer.parseInt(can);
            imp = precio * cantidad;
            total = total + imp;
            registro_examen.examen_laboratorio.tablaCaja.setValueAt(Math.rint(imp * 100) / 100, i, 4);

        }
        registro_examen.examen_laboratorio.lblTotal.setText("" + Math.rint((total+isv) * 100) / 100);
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("select codigo_laboratorio as 'Codigo', nombre as 'Nombre', precio as 'Precio' from servicio_laboratorio WHERE nombre LIKE '%"+name+"%' ");
    ...
    private void btnMenosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMenosActionPerformed
        if (tabla.getRowCount() > 0) {
            try {
                String cant = null;
                DefaultTableModel tabladet = (DefaultTableModel) registro_examen.examen_laboratorio.tablaCaja.getModel();
                ...
                if (fila == -1) {
                    ...
                    if (this.txtCantidad.getText().equals("")) {
                        ...
                        for (int i = 0; i < registro_examen.examen_laboratorio.tablaCaja.getRowCount(); i++) {
                            Object com = registro_examen.examen_laboratorio.tablaCaja.getValueAt(i, 0);
                            if (cod.equals(com)) {
                                j = i;
                                ErrorAlert er = new ErrorAlert(new JFrame(), true);
                                er.titulo.setText("OOPS...");
                        ...
                        if (c == 0) {
                            ...
                            registro_examen.examen_laboratorio.tablaCaja.setModel(tabladet);
                            calcular();
                        }
                    }
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_laboratorio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_laboratorio dialog = new lista_laboratorio(new javax.swing.JFrame(), true);
