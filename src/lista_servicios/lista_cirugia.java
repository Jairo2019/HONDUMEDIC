 ...
 * @author Rojeru San
 */
public class lista_cirugia extends javax.swing.JDialog {
...
PreparedStatement pst=null;
    public lista_cirugia(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
 ...
 private void Get_Data(){
        String sql="select codigo_cirugia as 'Codigo', nombre as 'Nombre', precio as 'Precio' from cirugia";
    ...
    public void calcular() {
        ...
        for (int i = 0; i < cirugia.registrar_cirugia.tablaCaja.getRowCount(); i++) {
            pre = cirugia.registrar_cirugia.tablaCaja.getValueAt(i, 2).toString();
            can = cirugia.registrar_cirugia.tablaCaja.getValueAt(i, 3).toString();
            precio = Double.parseDouble(pre);
            cantidad = Integer.parseInt(can);
            imp = precio * cantidad;
            total = total + imp;
            cirugia.registrar_cirugia.tablaCaja.setValueAt(Math.rint(imp * 100) / 100, i, 4);

        }
        cirugia.registrar_cirugia.lblTotal.setText("" + Math.rint((total+isv) * 100) / 100);
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("select codigo_cirugia as 'Codigo', nombre as 'Nombre', precio as 'Precio' from cirugia WHERE nombre LIKE '%"+name+"%' ");
    ...
    private void btnMenosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMenosActionPerformed
        if (tabla.getRowCount() > 0) {
            try {
                String cant = null;
                DefaultTableModel tabladet = (DefaultTableModel) cirugia.registrar_cirugia.tablaCaja.getModel();
                ...
                if (fila == -1) {
                    ...
                    if (this.txtCantidad.getText().equals("")) {
                        ...
                        for (int i = 0; i < cirugia.registrar_cirugia.tablaCaja.getRowCount(); i++) {
                            Object com = cirugia.registrar_cirugia.tablaCaja.getValueAt(i, 0);
                            if (cod.equals(com)) {
                                j = i;
                                ErrorAlert er = new ErrorAlert(new JFrame(), true);
                                er.titulo.setText("OOPS...");
                        ...
                        if (c == 0) {
                            ...
                            cirugia.registrar_cirugia.tablaCaja.setModel(tabladet);
                            calcular();
                        }
                    }
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_cirugia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_cirugia dialog = new lista_cirugia(new javax.swing.JFrame(), true);
