 ...
 * @author Rojeru San
 */
public class lista_emergencia extends javax.swing.JDialog {
...
PreparedStatement pst=null;
    public lista_emergencia(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
 ...
 private void Get_Data(){
        String sql="select codigo_emergencia as 'Codigo', nombre as 'Nombre', precio as 'Precio' from servicio_emergencia";
    ...
    public void calcular() {
        ...
        registro_examen.examen_emergencia.lblTotal.setText("" + Math.rint((total+isv) * 100) / 100);
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("select codigo_emergencia as 'Codigo', "
                    + "nombre as 'Nombre', "
                    + "precio as 'Precio' from servicio_emergencia WHERE "
                    + "nombre LIKE '%"+name+"%' OR codigo_emergencia LIKE '%"+name+"%'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_emergencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_emergencia dialog = new lista_emergencia(new javax.swing.JFrame(), true);
