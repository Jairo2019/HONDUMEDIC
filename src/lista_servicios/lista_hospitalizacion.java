...
public static String cual=""; //saber que formulario esta pidiendo información
 ...
 private void Get_Data(){
    ...
    public void calcular() {
        ...
        registro_examen.examen_hospitalizacion.lblTotal.setText("" + Math.rint((total+isv) * 100) / 100);
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("select codigo_hospitalizacion as 'Codigo',"
                    + " nombre as 'Nombre',"
                    + " precio as 'Precio' from servicio_hospitalizacion WHERE nombre LIKE '%"+name+"%' or codigo_hospitalizacion LIKE '%"+name+"%' ");
