 ...
 * @author Rojeru San
 */
public class lista_ambulancia extends javax.swing.JDialog {
...
PreparedStatement pst=null;
 ...
 private void Get_Data(){
        String sql="select codigo_ambulancia as 'Codigo', nombre as 'Nombre', precio as 'Precio' from servicio_ambulancia";
    ...
    public void calcular() {
        ...
        ambulancia.ambulancia.lblTotal.setText("" + Math.rint((total+isv) * 100) / 100);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_ambulancia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_ambulancia dialog = new lista_ambulancia(new javax.swing.JFrame(), true);
