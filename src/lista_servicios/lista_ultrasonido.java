 ...
 * @author Rojeru San
 */
public class lista_ultrasonido extends javax.swing.JDialog {
...
PreparedStatement pst=null;
    public lista_ultrasonido(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
 ...
 private void Get_Data(){
        String sql="select codigo_ultrasonido as 'Codigo', nombre as 'Nombre', precio as 'Precio' from servicio_ultrasonido";
    ...
    public void calcular() {
        ...
        registro_examen.examen_ultrasonido.lblTotal.setText("" + Math.rint((total+isv) * 100) / 100);
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("select codigo_ultrasonido as 'Codigo', nombre as 'Nombre', precio as 'Precio' from servicio_ultrasonido WHERE nombre LIKE '%"+name+"%' ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_ultrasonido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_ultrasonido dialog = new lista_ultrasonido(new javax.swing.JFrame(), true);
