 ...
 * @author Rojeru San
 */
public class lista_rayosx extends javax.swing.JDialog {
...
PreparedStatement pst=null;
    public lista_rayosx(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
 ...
 private void Get_Data(){
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("select codigo_rayosx as 'Codigo',"
                    + " nombre as 'Nombre',"
                    + " precio as 'Precio' "
                    + "from servicio_rayosx WHERE nombre LIKE '%"+name+"%' or codigo_rayosx LIKE '%"+name+"%' ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_rayosx.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_rayosx dialog = new lista_rayosx(new javax.swing.JFrame(), true);
