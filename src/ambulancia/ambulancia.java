 ...
 int filas;
  ...
  private void Get_Data(){
    ...
    void actualizarStock() {
     ...
     void sum_ingreso(){
         try{
         String sql= "select sum(importe) FROM detalle_test_ambulancia WHERE idventa='"+numFac.getText()+"'";
     ...
     void edit_ingreso(){
         ...
         String sql= "UPDATE test_ambulancia set total ='"+total+"' where codigo='"+numFac.getText()+"'";
         try{
            con=Conexion.ConnectDB();
            pst=con.prepareStatement(sql);
            pst.execute();
...
private void edit_detalle(){
    ...
    private void tableCajaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableCajaMouseClicked
        try {
            ...
            txtdestino.setText(tableCaja.getModel().getValueAt(row,6).toString()) ;
            txtkm.setText(tableCaja.getModel().getValueAt(row,7).toString()) ;
