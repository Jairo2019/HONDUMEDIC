 ...
 * @author Rojeru San
 */
public class registrar_ambulancias extends javax.swing.JInternalFrame {
Connection con=null;
Date dato = null;
ResultSet rs=null;
PreparedStatement pst=null;
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Ambulancias");

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/list_ambulance_48.png"))); // NOI18N
        ...
        jTabbedPane2.addTab("Ambulancias", jPanel10);
        ...
        gridBagConstraints.insets = new java.awt.Insets(34, 341, 0, 0);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(27, 31, 0, 335);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(64, 328, 0, 0);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(63, 348, 0, 0);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(53, 31, 0, 335);
        ...
        gridBagConstraints.ipady = 10;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(55, 31, 0, 335);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(60, 365, 0, 0);
        ...
        gridBagConstraints.ipady = 10;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(51, 31, 20, 335);
        ...
        jTabbedPane2.addTab("Nuevo Ambulancia", jPanel3);
...
private void Get_Data(){
        String sql="select codigo_ambulancia as 'Codigo', nombre as 'Nombre', marca as 'Descripción', year as 'Precio' from registrar_ambulancia";
        try{
    ...
    private void Reset()
{
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        try{
            ...
            String sql= "insert into registrar_ambulancia(nombre,marca,year) values ('"+txtName.getText()+"','" + txtDescripcion.getText() +"','" +txtPrecio.getText()+ "')";
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try
        {
            ...
            if (P==0)
            {
                ...
                String sql= "delete from registrar_ambulancia where codigo_ambulancia= '" + txtCodigo.getText() + "'";
                pst=con.prepareStatement(sql);
                //        pst.execute();
