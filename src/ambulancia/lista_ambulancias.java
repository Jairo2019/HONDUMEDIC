 ...
 * @author Rojeru San
 */
public class lista_ambulancias extends javax.swing.JDialog {
...
PreparedStatement pst=null;
    public lista_ambulancias(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        tabla.getTableHeader().setForeground(Color.white);
    ...
    private void initComponents() {
        ...
        send.setText("Agregar Ambulancia");
    ...
    private void Get_Data(){
            String sql="select codigo_ambulancia as 'Codigo', nombre as 'Nombre', marca as 'Marca', year as 'Año' from registrar_ambulancia";
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("select codigo_ambulancia as 'Codigo', nombre as 'Nombre', marca  'Marca', year as 'Año' from registrar_ambulancia WHERE nombre LIKE '%"+name+"%' ");
        ...
        if (tabla.getRowCount() > 0) {
            try {
                ...
                if (fila == -1) {
                    ...
                    int c = 0;
                    int j = 0;
                    ambulancia.txtambulancia.setText(nom);
                    this.dispose();
                }
            } catch (Exception e) {
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lista_ambulancias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                lista_ambulancias dialog = new lista_ambulancias(new javax.swing.JFrame(), true);
