 ...
 * @author Rojeru San
 */
public class examen_rayosx extends javax.swing.JInternalFrame {
...
static Conexion cc = new Conexion();
 ...
 int filas;
  ...
  private void Get_Data(){
     ...
     void sum_ingreso(){
         try{
         String sql= "select sum(importe) FROM detalle_test_rayosx WHERE idventa='"+numFac.getText()+"'";
    ...
    private void show_detalle(){
        String sql="select codigo as 'Codigo',"
                ...
                + "importe as 'Importe' "
                + "from detalle_test_rayosx where idventa='" + codetest.getText() + "' and estado=1";
        try{
         pst=con.prepareStatement(sql);
         rs= pst.executeQuery();
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
        ...
        try{
            ...
            String sql= "insert into test_rayosx("
                    + "numfact,"
                    + "paciente,"
                    + "medico,"
                    + "encargado,"
    ...
    private void btns_adminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btns_adminActionPerformed
        empleados.lista_empleados_admin.cual="11";
    ...
    private void btnserviciosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnserviciosActionPerformed
        new cajaservicios.lista_caja_rayosx(new JFrame(), true).setVisible(true); // TODO add your handling code here:
