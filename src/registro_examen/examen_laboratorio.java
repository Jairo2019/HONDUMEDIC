 ...
 * @author Rojeru San
 */
public class examen_laboratorio extends javax.swing.JInternalFrame {
...
static Conexion cc = new Conexion();
 ...
 int filas;
    ...
    private void initComponents() {
        ...
        jTabbedPane2.addTab("Registro de Examenes", jPanel10);
        ...
        jTabbedPane2.addTab("Nuevo Examen", jPanel3);
  ...
  private void Get_Data(){
        limpiaCampos();
        String sql="select codigo as 'Codigo',paciente as 'Paciente', medico_1 as 'Realizo Examen', medico_2 as 'Indico Examen',num_habitacion as 'Habitación',observaciones as'Observaciones',fecha as 'Fecha y Hora', total as 'Total (L)' from test_laboratorio";
        try{
    ...
    for (int i = 0; i <tablaCaja.getRowCount(); i++) {
        ...
        String sql= "insert into detalle_test_laboratorio(idventa,codigo,p_s,precio,cantidad,importe) values ('"+numFac.getText()+"','" +codigo+"','" + p_s +"','" +precio+"','" +cantidad+"','" +importe+ "')";
    ...
    private void show_detalle(){
        String sql="select codigo as 'Codigo',p_s as 'Prodcuto/Servicio',precio as 'Precio',cantidad as 'Cantidad',importe as 'Importe' from detalle_test_laboratorio where idventa='" + numFac.getText() + "' ";
        try{
         pst=con.prepareStatement(sql);
         rs= pst.executeQuery();
     ...
     void sum_ingreso(){
         try{
         String sql= "select sum(importe) FROM detalle_test_laboratorio WHERE idventa='"+numFac.getText()+"'";
     ...
     void edit_ingreso(){
         ...
         String sql= "UPDATE test_laboratorio set total ='"+total+"' where codigo='"+numFac.getText()+"'";
         try{
            con=Conexion.ConnectDB();
            pst=con.prepareStatement(sql);
            pst.execute();
...
private void edit_detalle(){
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
        ...
        try{
            ...
            String sql= "insert into test_laboratorio(codigo,paciente,medico_1,medico_2,num_habitacion,observaciones,fecha,total) values ('"+numFac.getText()+"','" +txtpaciente.getText()+"','" +txtmedicoadmin.getText()+"','" +txtmedicoindica.getText()+"','"+txtnumhabitacion.getText()+"','" +txtdescripcion.getText()+"','" + txtFecha.getText()+"','" +lblTotal.getText() + "')";
            pst=con.prepareStatement(sql);
            pst.execute();
            actualizarStock(); 
            ingresar_detalle();
    ...
    private void btns_pacienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btns_pacienteActionPerformed
        //pacientes.lista_pacientes_laboratorio.cual="0";
