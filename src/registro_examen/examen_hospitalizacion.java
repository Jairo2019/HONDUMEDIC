...
void sum_ingreso(){
     ...
     void edit_ingreso(){
         ...
         String sql= "UPDATE test_hospitalizacion set observaciones='"+txtdescripcion.getText()
...
private void edit_detalle(){
    ...
    private String eliminar_registro(String codigo){
        try
        {
            ...
            if (P==0){
                ...
                String sql= "delete from detalle_test_hospitalizacion where codigo= '" + codigo + "' and idventa = '"+ numFac.getText() + "'";
                pst=con.prepareStatement(sql);
                pst.execute();
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
        ...
        try{
            ...
            String sql= "insert into test_hospitalizacion("
                    + "paciente,"
                    + "encargado,"
                    + "medico_3,"
                    + "num_habitacion,"
